...
# Current Module
$currentModule = new FormSubmissions();
$currentModule->_moduleDir = basename(__DIR__);
...
$getName = $module->fetchAll("WHERE `dir`='".$currentModule->_moduleDir."'");
$currentModule->_moduleName = $getName[0]->getName();
# Content
ob_start();

# Get module content
echo $currentModule->moduleIndexAction(1);

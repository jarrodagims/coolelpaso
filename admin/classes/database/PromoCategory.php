...
class PromoCategory extends Category{
	...
	public $_moduleCategoryName = 'PromoCategory';
	// Static Variables
	protected static $_addLabel = 'Add Promotion Category';
	protected static $_editLabel = 'Edit Promotion Category';

	// Inherited Variables - Model
	protected $_dbTable	= 'promo_categories';
	protected $_permalinkField = 'permalink';
	protected $_action = 'index';
	
	// Inherited Variables - Category
	protected $_childClass = 'Promo';

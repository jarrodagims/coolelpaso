...
class News extends Model{
	// Module Config
	public $_moduleName	= 'News';
	public $_moduleDir = 'news';
	public $_moduleTable = 'news';
	public $_moduleTableCategories = 'news_categories';
	public $_moduleClassName = 'News';
	public $_moduleCategoryClassName = 'NewsCategory';
	public $_moduleDescription = 'This section allows administrators to create, modify, and delete News Articles';
	public $_moduleIcon = 'fa-newspaper-o';
	public $_moduleImageCanvasX = 360;
	public $_moduleImageCanvasY = 230;
	...
	// Static Variables
	protected static $_addLabel = 'Add News Item';
	protected static $_editLabel = 'Edit News Item';
	protected static $_newsUrl = '/news';
	protected static $_fileTypes = array(
									'pdf'
									);

	// Inherited Variables
	protected $_filePath = 'files/news/';
	protected $_dbTable	= 'news';
	...
	public function indexAction(){
        ...
        <div class="news">
        	<?php
            /*<h2><?php echo process($this->getHeadline()); ?></h2>
			*/
			?>
			<?php if($this->getImage()): ?>
			<?php echo $this->buildImage(); ?>
			<?php endif; ?>
            <span class="date"><?php echo printDate($this->getDate()); ?></span>
				...
				<div class="col-sm-6">
					<div class="panel panel-custom">
						...
						<div class="panel-body">
							...
							<!-- Post Date/Time -->
							<div class="form-group">
								<label for="post_date" class="required">Post Date/Time</label>
							...
							<!-- Remove Date/Time -->
							<div class="form-group">
								<label for="remove_date" class="">Remove Date/Time</label>

<?php
class LocationCategory extends Category{
	// Module Configuration
	public $_moduleClassName = 'Location';
	public $_moduleCategoryName = 'LocationCategory';
	// Static Variables
	protected static $_addLabel = 'Add Location Category';
	protected static $_editLabel = 'Edit Location Category';

	// Inherited Variables - Model
	protected $_dbTable	= 'location_categories';
	protected $_permalinkField = 'permalink';
	protected $_action = 'index';
	
	// Inherited Variables - Category
	protected $_childClass = 'Location';
	...
	public function getHrefPrefix(){return $this->_hrefPrefix;}
	...
	public function setRecords($records = ''){
		if(is_array($records)){
			$this->_locations = $records;
		}elseif($this->getId()){
			$records = new $this->_moduleClassName();
			$this->_locations = $records->fetchAll("WHERE `category` = ".$this->getId(), "ORDER BY `sort_order`");
		}else{

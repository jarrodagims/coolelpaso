<?php
class FormCategory extends Category{
	// Module Configuration
	public $_moduleClassName = 'Form';
	public $_moduleCategoryName  = 'Form Category';
	// Static Variables
	protected static $_addLabel = 'Add Form Category';
	protected static $_editLabel = 'Edit Form Category';

	// Inherited Variables - Model
	protected $_dbTable	= 'form_categories';
	protected $_permalinkField = 'permalink';
	protected $_action = 'index';
	
	// Inherited Variables - Category
	protected $_childClass = 'Form';

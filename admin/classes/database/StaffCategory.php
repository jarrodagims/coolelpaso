<?php
class StaffCategory extends Category{
	// Module Configuration
	public $_moduleClassName = 'Staff';
	public $_moduleCategoryName = 'StaffCategory';
	// Static Variables
	protected static $_addLabel = 'Add Staff Member Category';
	protected static $_editLabel = 'Edit Staff Member Category';

	// Inherited Variables - Model
	protected $_dbTable	= 'staff_categories';
	protected $_permalinkField = 'permalink';
	protected $_action = 'index';
	
	// Inherited Variables - Category
	protected $_childClass = 'Staff';
	...
	public function setRecords($records = ''){
		if(is_array($records)){
			...
			$this->_staff = $records->fetchAll("WHERE `category` = ".$this->getId(), "ORDER BY `sort_order`");
		}else{
			$this->_staff = array();
		}
		return $this;

					...
					<div class="form_content">
						...
						<div class="row">
							<div class="col-md-6">	
								...
								<?php echo FormComponent::colorPicker(array ('format'=>'hex', 'name'=>'primary_color', 'defaultColor'=>'#000000')); ?>
							</div>
    						<div class="col-md-6">
    						<label for="'button_color">Button Color</label>
    							<?php echo FormComponent::colorPicker(array ('format'=>'hex', 'name'=>'button_color', 'defaultColor'=>'#000000')); ?>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">	
